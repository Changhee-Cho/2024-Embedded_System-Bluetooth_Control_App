...
public class p2Activity extends Activity {
    ...
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "p2Activity";
    ...
    private void initUI(){
        ...
        ultra = findViewById(R.id.p5_display);
        cds = findViewById(R.id.p2_cds);
        poten = findViewById(R.id.p2_poten);
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(p2Activity.this);
