...
public class MainActivity extends Activity {
    ...
    //- UI Widget ------------------------------------------------------------
    private Button mBtBTN, mRedBtn, mGreenBtn, mBlueBtn;
    private TextView mTvTemp, mTvIll;

    private boolean bRedOn = false, bGreenOn = false, bBlueOn = false, bWhiteOn = false;
    ...
    public void clickFunc(View v) {
        ...
        switch(v.getId()) {
            ...
            case R.id.tg_btn_buzzer:
                sendMessage((((ToggleButton) v).isChecked()) ? "@BUZ,1#" : "@BUZ,0#");
                break;
            case R.id.red_btn:
                ((Button) v).setTextColor((!bRedOn) ? Color.RED : Color.BLACK);
                sendMessage((!bRedOn) ? "@RED,1#" : "@RED,0#");
                bRedOn = !bRedOn;
                break;
            case R.id.green_btn:
                ((Button) v).setTextColor((!bGreenOn) ? Color.GREEN : Color.BLACK);
                sendMessage((!bGreenOn) ? "@GED,1#" : "@GED,0#");
                bGreenOn = !bGreenOn;
                break;
            case R.id.blue_btn:
                ((Button) v).setTextColor((!bBlueOn) ? Color.BLUE : Color.BLACK);
                sendMessage((!bBlueOn) ? "@BED,1#" : "@BED,0#");
                bBlueOn = !bBlueOn;
                break;
            case R.id.white_btn:
                ((Button) v).setTextColor((!bWhiteOn) ? Color.WHITE : Color.BLACK);
                mRedBtn.setTextColor(!bWhiteOn ? Color.RED : Color.BLACK);
                mGreenBtn.setTextColor(!bWhiteOn ? Color.GREEN : Color.BLACK);
                mBlueBtn.setTextColor(!bWhiteOn ? Color.BLUE : Color.BLACK);
                sendMessage((!bWhiteOn) ? "@WED,1#" : "@WED,0#");
                bWhiteOn = !bWhiteOn;
                break;
        }
    }
