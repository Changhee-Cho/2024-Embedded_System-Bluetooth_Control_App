...
public class p6Activity extends Activity {
    ...
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "p6Activity";
    ...
    public void clickFunc(View v) {
        switch(v.getId()) {
            case R.id.btBTN:
                ...
                break;
            case R.id.p6_speedCheck:
                sendMessage("@6SC#");
                break;
            case R.id.p6_speedup:
                sendMessage("@6SU#");
                break;
            case R.id.p6_speeddown:
                sendMessage("@6SD#");
                break;
            case R.id.p6_top:
                sendMessage("@6TP#");
            ...
            case R.id.p6_stop:
                sendMessage("@6ST#");
                break;
            case R.id.p6_ultraleft:
                sendMessage("@6UL#");
                break;
            case R.id.p6_ultrafront:
                sendMessage("@6UF#");
                break;
            case R.id.p6_ultraright:
                sendMessage("@6UR#");
                break;
        }
    }
    ...
    private void initUI(){
        ...
        tv1=findViewById(R.id.p6_display);
        tv2=findViewById(R.id.p6_showleft);
        tv3=findViewById(R.id.p6_showRight);
        tv4=findViewById(R.id.p6_showfront);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(p6Activity.this);
