...
public class p8Activity extends Activity {
    //------------------------------------------------------------------------
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "p8Activity";
    ...
    private TextView ultra, cds, poten;
    ...
    private void initUI(){
        ...
        ultra = findViewById(R.id.p8_display);
        ultra.setText("191");
        cds = findViewById(R.id.p8_cds);
        cds.setText("191");
        poten = findViewById(R.id.p8_poten);
        poten.setText("191");
    }
    ...
    private void setResultValue(String readMessage) {
        ...
        else if("11L".equals(cmd)){
            cds.setText(data);
        }
        else if("11R".equals(cmd)){
            poten.setText(data);
        }
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(p8Activity.this);
