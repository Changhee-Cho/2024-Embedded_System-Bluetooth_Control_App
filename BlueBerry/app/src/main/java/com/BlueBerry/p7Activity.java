...
public class p7Activity extends Activity {
    //------------------------------------------------------------------------
    //- Member Variable
    //------------------------------------------------------------------------
    private static final String TAG = "p7Activity";
    ...
    public void clickFunc(View v) {
        switch(v.getId()) {
            case R.id.btBTN:
                ...
                break;
            case R.id.p7_parking:
                sendMessage("@7PK#");
                break;
            case R.id.p7_driving:
                sendMessage("@7DV#");
                break;
    ...
    private void initUI(){
        ...
        imageView=findViewById(R.id.p7_imageView);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what)
            {
                ...
                case Constant.MESSAGE_START_IMAGE:
                    mDialog = new ProgressDialog(p7Activity.this);
